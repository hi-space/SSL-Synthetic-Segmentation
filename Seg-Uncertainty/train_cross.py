...
from trainer_cross import AD_Trainer
    ...
    for i_iter in range(30001, args.num_steps):
        ...
        for sub_i in range(args.iter_size):
            ...
            with Timer("Elapsed time in update: %f"):
                loss_seg1, loss_seg2, loss_adv_target1, pred_source, pred_target1, val_loss_s, val_loss_t, total_loss = Trainer.gen_update(images, images_t, labels, labels_t, i_iter)
                ...
                if args.lambda_adv_target1 > 0:
                    loss_D1 = Trainer.dis_update(pred_source, pred_target1)
        ...
        logger.info(
        '\033[1m iter = %8d/%8d \033[0m loss_seg1 = %.3f loss_seg2 = %.3f loss_adv1 = %.3f, loss_D1 = %.3f, val_loss_s=%.3f, val_loss=%.3f, total_loss=%.3f'%(i_iter, args.num_steps, loss_seg_value1, loss_seg_value2, loss_adv_target_value1, loss_D_value1, val_loss_s, val_loss_t, total_loss))
        ...
        if i_iter >= args.num_steps_stop - 1:
            ...
            torch.save(Trainer.G_s.state_dict(), osp.join(args.snapshot_dir, 'GTA5_' + str(args.num_steps_stop) + '_s.pth'))
