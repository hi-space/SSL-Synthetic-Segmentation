...
def main():
    ...
    if args.model == 'DeepLab':
        ...
        if args.restore_from[:4] == 'http' :
            ...
            print('restored at %s' % args.restore_from)
    ...
    # interp = nn.Upsample(size=(args.input_size[1], args.input_size[0]), mode='bilinear')
    ...
    interp_target = nn.Upsample(size= args.crop_size, mode='bilinear', align_corners=True)
